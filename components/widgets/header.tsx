        ...
        <section>
          <ul className="hidden lg:flex items-center gap-x-8">
            <li>
              <Link
                href="/"
                className="relative text-white transition-colors duration-300 before:absolute before:left-0 before:-bottom-2 before:w-full before:h-0.5 before:bg-white before:rounded-full before:transition-all before:duration-300"
              >
                Inicio
              </Link>
            </li>
